...
The original WordPress page for Post-War Letters contained only a single sentence of static content: "Letters written after the Revolutionary War including Governorship." Beyond this, the page relied on a TimelineJS embed (Knight Lab Timeline.js) fed by a Google Sheets spreadsheet, which is now dead. The Google Sheets key was: `0AlXgo-F1C709dHM2dUs3M1FkWGVmMGFWT2poanZVaFE`. The spreadsheet no longer appears to be publicly accessible.

**What belongs here:** This section should contain Richard Howell's post-war correspondence. Richard Howell served as Governor of New Jersey from 1793 to 1801 (six terms, elected annually). Letters from this period would include gubernatorial correspondence, correspondence relating to the Whiskey Rebellion (1794, in which Howell commanded NJ militia forces), and personal correspondence.
